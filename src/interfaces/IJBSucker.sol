...
interface IJBSucker is IERC165 {
    ...
    function mapToken(JBTokenMapping calldata map, uint256 tokensDisabled) external payable;
    function mapTokens(JBTokenMapping[] calldata maps, uint256 tokensDisabled) external payable;
    function prepare(
